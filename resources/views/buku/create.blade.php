    ...
    <div class="container py-3">
        ...
        <form action="{{ route('buku.store') }}" method="post">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="kode_buku" id="kode_buku" class="form-control" placeholder="Kode Buku">
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="jumlah_buku" id="jumlah_buku" class="form-control" placeholder="Jumlah Buku">
            </div>
            <div class="form-group mb-3">
